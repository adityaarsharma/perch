...
import { auditDisk } from './diagnostics/disk.js';
import { scanMalware } from './security/malware.js';
import { auditThumbnails } from './performance/thumbnails.js';
import { auditUnusedPlugins } from './cleanup/plugins-cleanup.js';
import { auditMediaOrphans } from './cleanup/media-orphans.js';
import { auditRevisions } from './cleanup/revisions.js';
import { auditTranslations } from './cleanup/translations.js';
import { auditHtaccess } from './security/htaccess.js';
import { getCoreStatus } from './operations/core.js';
import { auditCron } from './operations/cron.js';
import { auditWpConfig } from './security/wp-config.js';
import { auditCaching } from './performance/caching.js';
import { auditWooCommerce } from './plugins/woocommerce.js';
import { auditYoast } from './plugins/yoast.js';
